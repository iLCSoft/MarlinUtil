...
//-----------------------------------------------------------------------
 public:
  ...
  Point2D() : x(0.),y(0.),rz2(0.),rz(0.) { }
  Point2D(double _x,double _y) : x(_x), y(_y), rz2(x*x+y*y), rz(sqrt(rz2)) {}
  Point2D(Point2D const & a): x(a.x), y(a.y), rz2(a.rz2), rz(a.rz)  {}
...
//-----------------------------------------------------------------------
 public:
  ...
  Point3D(double _x,double _y,double _z) : Point2D(_x,_y), z(_z), r(rz2+z*z) {}
